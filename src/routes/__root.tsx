  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "A versão 2.0 do Histórico Freitas está no ar." },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bf06bff2-138a-4a33-8b46-032b91a61bd7/id-preview-720867f3--39ea3609-e5bc-46a6-93f4-36044ce8cbad.lovable.app-1785805331783.png",
      },
      {
        name: "twitter:image",
        content:
