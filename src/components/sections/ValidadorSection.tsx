...
export default function SignalPercentageValidator() {
  ...
  const auditResults = useMemo(() => {
    ...
    const strategyEngines = [
      { key: "A1", label: "A1 · P=M", fn: buildA1, isTop1: true },
      { key: "A2", label: "A2 · Rep. Simples", fn: buildA2, isTop1: true },
      { key: "A3", label: "A3 · Min 9 (2ª)", fn: buildA3, isTop1: true },
      { key: "A4", label: "A4 · 1ª Dezena", fn: buildA4, isTop1: true },
      { key: "A5", label: "A5 · 2ª Dezena", fn: buildA5, isTop1: true },
      ...
      { key: "A17", label: "A17 · Min 5 (1ª)", fn: buildA1Minuto5, isTop1: false },
      { key: "A18", label: "A18 · Min 5 (2ª)", fn: buildA2Minuto5, isTop1: false },
